# Content
This repository contains the Implementation of dynamic security scanning using OWASP ZAP in continuous integration and deployment of web applications as well as the code of the app used in the testing process. The implementation was realised for an engineering thesis defended in 2024.

### Reports generated by OWASP ZAP are located in /reports folder 


### Original .md file of the tested application. 
<div align="center">
    <br />
 <h3>↓ ↓ ↓</h3>  
</div>
